		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#meuportfoliosap-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"meuportfoliosap-display": {
								"semanticObject": "meuportfoliosap",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=meu.portfolio.sap",
									"url": sap.ui.require.toUrl("meu/portfolio/sap")
								}
							}
						}
					}
